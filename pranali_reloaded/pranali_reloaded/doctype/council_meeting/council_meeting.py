...
class CouncilMeeting(Document):
	...
	def calculate_totals(self):
		self.total_attendance = cint(self.district_council_members) + cint(self.rotarians) + cint(self.club_rotaractors) + cint(self.alumini) + cint(self.pis) + cint(self.guest)
